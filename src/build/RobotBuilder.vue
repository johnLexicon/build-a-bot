<template>
    ...
    <div class="middle-row">
      <div class="left part">
        <img v-bind:src="selectedRobot.arms.src" title="left arm"/>
    ...
    computed: {
        selectedRobot() {
            return {
                ...
                arms: availableParts.arms[this.selectedArmsIndex],
                base: availableParts.bases[this.selectedBaseIndex]
            }
        },
        headBorderStyle(){
            const borderValue = '3px solid';
            const colorValue = 'red';
            return {
                border: this.selectedRobot.head.onSale ? `${borderValue} ${colorValue}` : borderValue
            }
        }
    },
    methods: {
        ...
        selectNextArm(){
            this.selectedArmsIndex = getNextValidIndex(this.selectedArmsIndex, this.availableParts.arms.length);
        },
        selectPreviousArm(){
            this.selectedArmsIndex = getPreviousValidIndex(this.selectedArmsIndex, this.availableParts.arms.length);
        },
        selectNextBase(){
